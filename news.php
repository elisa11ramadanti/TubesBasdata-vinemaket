        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12 bg-dark py-2 my-4">
                    <h4 class="text-white">News About Movie</h4>
                </div>
            </div>
            ...
            <div class="berita">
                <?php
                include 'koneksi.php';
                $data = mysqli_query($mysqli, "SELECT * FROM berita");
                while ($pilih = mysqli_fetch_array($data)) {
                    echo "<h1>".$pilih['judul_berita']."</h1>
                          <p>".$pilih['penulis']."".$pilih['tanggal']."</p>
                             <img src=".$pilih['gambar']." width = '45%'>
                         <p>".$pilih['detail']."</p>";
                }
                ?>
